...
def get_post_type(msg): return msg['post_type']


# 获取信息类型 群聊/私聊 group/private
def get_message_type(msg): return msg['message_type']
...
# 获取QQ号
def get_user_id(msg): return msg['user_id']
...
# 获取发送的信息
def get_raw_message(msg): return msg['raw_message']


# 改变发送的信息
def set_raw_message(msg, new_info): msg['raw_message'] = new_info
